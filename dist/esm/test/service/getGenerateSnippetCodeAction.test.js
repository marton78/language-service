...
describe('getGenerateSnippetCodeAction', () => {
    it('generates code in a new file', () => {
        ...
        const action = getGenerateSnippetCodeAction([diagnostic], link, 'step_definitions/steps.ts', true, undefined, 'tsx', new ParameterTypeRegistry());
...
`,
    ...
    it('generates code in an existing file', () => {
        ...
        const action = getGenerateSnippetCodeAction([diagnostic], link, 'step_definitions/steps.ts', false, undefined, 'tsx', new ParameterTypeRegistry());
        const expectedAction = {
            title: 'Define in step_definitions/steps.ts',
            diagnostics: [
                {

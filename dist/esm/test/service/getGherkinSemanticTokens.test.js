...
import { getGherkinSemanticTokens, semanticTokenTypes, } from '../../src/service/getGherkinSemanticTokens.js';
...
`;
        ...
        const cucumberExpression = new CucumberExpression('I have {int} cukes in my {word}', parameterTypeRegistry);
        const regularExpression = new RegularExpression(/^I should( not)? be on the map$/, parameterTypeRegistry);
...
`;
        const parameterTypeRegistry = new ParameterTypeRegistry();
        const cucumberExpression = new CucumberExpression('I have {string} parameter', parameterTypeRegistry);

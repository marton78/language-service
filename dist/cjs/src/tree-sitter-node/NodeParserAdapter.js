...
// @ts-ignore
var tree_sitter_go_1 = __importDefault(require("tree-sitter-go"));
// @ts-ignore
var tree_sitter_java_1 = __importDefault(require("tree-sitter-java"));
// @ts-ignore
var tree_sitter_kotlin_1 = __importDefault(require("tree-sitter-kotlin"));
// @ts-ignore
...
// @ts-ignore
var tree_sitter_scala_1 = __importDefault(require("tree-sitter-scala"));
// @ts-ignore
    ...
    NodeParserAdapter.prototype.setLanguageName = function (languageName) {
        switch (languageName) {
            ...
            case 'c_sharp':
                ...
                break;
            case 'php':
                this.parser.setLanguage(tree_sitter_php_1.default.php);
                break;
            case 'ruby':
            ...
            case 'rust':
                ...
                break;
            case 'go':
                this.parser.setLanguage(tree_sitter_go_1.default);
                break;
            case 'scala':
                this.parser.setLanguage(tree_sitter_scala_1.default);
                break;
            case 'kotlin':
                this.parser.setLanguage(tree_sitter_kotlin_1.default);
                break;
            default:

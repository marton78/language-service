...
var rustLanguage_js_1 = require("../../src/language/rustLanguage.js");
describe('rustLanguage', function () {
    it('should extract string literal pattern', function () {
        var cases = [
            {
        ...
        cases.forEach(function (_a) {
            ...
            assert_1.default.strictEqual((0, rustLanguage_js_1.stringLiteral)(node), expected);
        });
    });
    it('should strip line continuations from expressions', function () {
        var cases = [
            {
        ...
        cases.forEach(function (_a) {
            var input = _a.input, expected = _a.expected;
            assert_1.default.strictEqual((0, rustLanguage_js_1.stripLineContinuation)(input), expected);
        });
    });
    it('should not strip invalid line continuations from expressions', function () {
        var cases = [
            {
...
//# sourceMappingURL=rustLanguage.test.js.map